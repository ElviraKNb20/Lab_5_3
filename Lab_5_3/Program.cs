...
namespace Lab_5_3
{
    ...
    class Atelier
    {
        public void dressMan()
        {
            ...
            IMenswear[] menswears = { new TShirt(36, 266.28, "синiй"), new Pants(38, 683, "чорний"), new Necktie(8, 89.80, "сiрий") };
        ...
        public void dressWoman()
        {
            ...
            IWomenswear[] womenswears = { new TShirt(36, 526.15, "рiзнокольоровий"), new Pants(36, 917, "бiлий"), new Skirt(34, 370, "бiлий") };
